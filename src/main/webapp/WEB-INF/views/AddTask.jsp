...
<head>
    ...
    <title>Create Task - Task Workspace</title>

    <!-- Bootstrap 5, Google Fonts & FontAwesome for Real App Feel -->
    ...
    <style>
        ...
        .left-brand-panel {
            background: linear-gradient(135deg, #1d4ed8 0%, #0c1524 100%);
        ...
        /* ==========================================================================
           ⭐ CUSTOM HIGH-VISIBILITY DATE/CALENDAR PICKER BUTTON STYLE
           ========================================================================== */
        .date-picker-custom {
            position: relative;
        }

        /* Webkit browsers (Chrome, Safari, Edge, Opera) ke liye calendar icon ko bright neon cyan banana */
        ...
        .btn-link-board:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(59, 130, 246, 0.5); }
...
<div class="split-auth-container">
    <div class="row g-0">
        ...
        <!-- Left Side: Branded Panel (With Top Left Arrow) -->
        <div class="col-md-4 left-brand-panel">
            ...
            <div class="mt-4 mb-3">
                <h3 class="brand-meta-title">Initialize<br>New <span>Log Stream.</span></h3>
                <p class="text-white small fw-bold mt-3 opacity-90">Add operations immediately inside isolated database cluster schema pools.</p>
            </div>
            <div class="brand-footer-text d-none d-md-block">
                <i class="fa-solid fa-square-kanban text-info me-1"></i> TaskWorkspace Stack
            </div>
        </div>
        ...
        <div class="col-md-8 right-form-panel">
            <form action="saveTask" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="taskName" class="form-control form-control-custom" placeholder="Enter operational task description" required>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <input type="number" name="duration" class="form-control form-control-custom" placeholder="Hours" min="1" required>
                        <span class="sub-alert-text"><i class="fa-solid fa-circle-info"></i> Bounds rule: Must be > 0 Hours</span>
                    </div>
                    
                    <!-- Timeline Due Date -->
                    <div class="col-sm-6 mb-3 date-picker-custom">
                        <label class="form-label-custom"><i class="fa-regular fa-calendar-days"></i> Timeline Due Date</label>
                        <!-- ⭐ CALENDAR BUTTON HIGHLIGHTED CLEARLY ACROSS CYAN LOGIC -->
                        <input type="date" name="dueDate" class="form-control form-control-custom" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="status" class="form-select form-select-custom">
                        ...
                        <option value="In Progress">🔵 Active Progress Loop</option>
                ...
                <div class="mb-4">
                    ...
                    <select name="priority" class="form-select form-select-custom">
                        <option value="High">🔴 High Priority Trapping</option>
                        <option value="Medium">🟡 Medium Execution Layer</option>
                        <option value="Low">🟢 Low Operational Metric</option>
                    </select>
                </div>

                <!-- Core Action Buttons Triggers -->
                <div class="row g-3">
                    <div class="col-md-7">
                        <button type="submit" class="btn btn-submit-save w-100">
                            <i class="fa-solid fa-cloud-arrow-up me-2"></i> Commit Stream Record
                        </button>
                    </div>
                    <div class="col-6 col-md-5">
                        <a href="viewTasks" class="btn btn-link-board w-100">
                            <i class="fa-solid fa-table-cells me-2"></i> Workspace
                        </a>
                    </div>
